...
handoffs:
  - label: Clarify Specification
    ...
    prompt: Identify underspecified areas in the current feature spec by asking up to 5 highly targeted clarification questions and encoding answers back into the spec. I want to clarify...
---
